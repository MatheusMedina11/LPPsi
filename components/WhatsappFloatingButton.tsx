...
export default function WhatsappFloatingButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-brand-700 py-3.5 pl-4 pr-5 text-white shadow-lg shadow-brand-900/20 transition-all duration-300 hover:scale-105 hover:bg-brand-800"
    >
      <svg
